  ...
  const sendTransaction = async () => {
    try {
      if (ethereum) {
        ...
        const transactionsContract = createEthereumContract();
        const parsedAmount = ethers.utils.parseEther(amount); // convert amount from decimal to hex so it can fit ethers
          ...
          params: [
            {
              ...
              to: addressTo,
              gas: "0x5208",
              value: parsedAmount._hex, // get the hex value from parsedAmount
            },
          ],
        });
